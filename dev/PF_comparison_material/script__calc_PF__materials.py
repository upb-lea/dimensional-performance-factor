...
materials = [mdb.Material.N49, mdb.Material.N87, mdb.Material.N95]
...
for i, material in enumerate(materials):
    print(f"\n{material = }\n")
    complex_permeability = mdb_data.get_complex_permeability(material=material,
    ...
    complex_permittivity = mdb_data.get_complex_permittivity(material=material,
